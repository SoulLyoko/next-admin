...
export default function LayoutActions() {
  const { isDark, toggleDark, settings, setShowSetting } = useLayoutStore()
  ...
  return (
    <>
      ...
      <Button type="text" icon={<Icon icon="ant-design:setting-outlined" />} onClick={() => setShowSetting(true)}></Button>
    </>
  )
}
